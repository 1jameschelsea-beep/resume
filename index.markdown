...
> - Maintains high food safety standards and proper handling practices.
> - Manages inventory by restocking commercial and frozen bakery items, monitoring product levels, and rotating stock to ensure freshness.
> - Operates bakery equipment such as bread slicers, ovens, and label printers.
> - Trained new hires in bakery procedures and cake counter service.
...
> - Managed accurate cash handling and POS transactions.
> - Managed inventory by restocking bakery items, monitoring product levels, and rotating stock to ensure
   freshness.
